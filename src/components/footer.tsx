...
const footerLinks: Record<string, { label: string; href: string }[]> = {
  Divisions: [
    { label: "TaxVolca Tax", href: "/services/tax" },
    { label: "TaxVolca Audit", href: "/services/audit" },
    { label: "TaxVolca Legal", href: "/services/legal" },
    { label: "TaxVolca Capital", href: "/services/capital" },
    { label: "TaxVolca Global", href: "/services/global" },
    { label: "TaxVolca AI", href: "/ai" },
  ],
  Solutions: [
    { label: "Startup Ecosystem", href: "/solutions/startup" },
    { label: "Corporate Suite", href: "/solutions/corporate" },
    { label: "NRI Solutions", href: "/solutions/nri" },
    { label: "MSME Growth", href: "/solutions/msme" },
